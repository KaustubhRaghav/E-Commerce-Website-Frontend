...
const Login = () => {
   ...
   *  Object with values of username and password user entered to register
   *
   * @returns {boolean}
   ...
   *  Object with values of username and password user entered to login
   *
  ...
  const login = async (formData) => {
    ...
    if (isValid) {
      ...
      try {
        ...
        const { token, username, balance } = successResult.data;
